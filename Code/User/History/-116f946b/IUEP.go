...
func RestGetAndUnmarshal(URL string, filters filters, start, limit uint, v any) (err error) {

	resp, err := RestGet(URL, filters, start, limit)
	if err != nil {
		return
	}
...
func RestGetAndUnmarshalMany(URL string, filters filters, start, limit uint, v []any) (err error) {
...
func RestGetToFile(filename string, URL string, filters filters, start, limit uint) (err error) {
